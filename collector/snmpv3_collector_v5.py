#!/usr/bin/env python3
"""
SNMPv3 Collector - pysnmp 5.4.4+ STABLE Windows
Collecte les donnees SNMP d'un switch et les envoie a l'API
VERSION STABLE: Marche avec pysnmp 5.x (RECOMMANDE pour Windows)
"""
...
try:
    ...
    print("\nInstalle pysnmp 5.4.4+:")
    print("  pip install pysnmp==5.4.4 pyopenssl cryptography --force-reinstall")
    sys.exit(1)
...
class SNMPv3Collector:
    """Collecteur SNMPv3 compatible pysnmp 5.4.4+"""
    ...
    def get_oid(self, oid: str) -> Optional[Any]:
        ...
        """
        try:
            # Creer l'utilisateur SNMPv3 (pysnmp 5.x)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="SNMPv3 Collector - pysnmp 5.4.4+ STABLE",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Exemples:
  # Mode TEST (avec localhost)
  python snmpv3_collector_v5.py --mode test --verbose
  
  # Mode PRODUCTION
  python snmpv3_collector_v5.py --mode production --host 192.168.1.1 --username admin
  
  # Test de connexion
  python snmpv3_collector_v5.py --test-only
        """
    )
